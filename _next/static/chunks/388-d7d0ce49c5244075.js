try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = "b7d036a8-e287-4fb6-ae1d-60d2c027a76c"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-b7d036a8-e287-4fb6-ae1d-60d2c027a76c"));
} catch (e) {}
  ...
  [388],
  {
    ...
    255: (e, t, r) => {
      ...
      function p(e) {
        ...
        delete a[s.NEXT_RSC_UNION_QUERY];
        let o = d(e),
        ...
        Object.entries(c)))
          Array.isArray(a)
            ? (c[r] = a.map((t) => f(u(t), e.params)))
            : "string" == typeof a && (c[r] = f(u(a), e.params));
        let m = Object.keys(e.params).filter((e) => "nextInternalLocale" !== e);
        if (e.appendParamsToQuery && !m.some((e) => h.includes(e)))
          for (let t of m) t in c || (c[t] = e.params[t]);
    ...
    650: (e, t, r) => {
      ...
      function h(e) {
        (n = (t, r) => {
          ...
          a
            ? (a.updateName(n),
              a.setAttributes({ "navigation.type": `router.${r}` }),
              (f.current = void 0))
            : (0, s.Nt)(e, {
                name: n,
                attributes: {
          ...
          l.jf.addEventListener("popstate", () => {
            f.current?.isRecording()
              ? (f.current.updateName(l.jf.location.pathname),
                f.current.setAttribute(o.i_, "url"))
              : (f.current = (0, s.Nt)(e, {
                  name: l.jf.location.pathname,
                  attributes: {
                    [o.JD]: "auto.navigation.nextjs.app_router_instrumentation",
            ...
            t?.[n] &&
              (t[n] = new Proxy(t[n], {
                apply(t, a, i) {
                  ...
                  return (
                    "push" === n
                      ? ((l = _(i[0])), (f["navigation.type"] = "router.push"))
                      : "replace" === n
                      ? ((l = _(i[0])),
                    ...
                    (r.current = (0, s.Nt)(e, { name: l, attributes: f })),
                    t.apply(a, i)
                  );
                },
              }));
                ...
                M.then(
                  (d) => {
                    let { flightData: g, canonicalUrl: R, postponed: O } = d,
                      ...
                      M = !1;
                    if (
                      (C.lastUsedTime || ((C.lastUsedTime = S), (M = !0)),
                      C.aliased)
                    ) {
                    ...
                    for (let e of g) {
                      ...
                      if (
                        (null === P &&
                          (P = (0, i.applyRouterStatePatchToTree)(R, A, y, w)),
                        null !== P)
                      ) {
                        if (a && g && O) {
                          ...
                          for (let t of (C.status !==
                            u.PrefetchCacheEntryStatus.stale || M
              ...
              (i =
                w === n.DEFAULT_SEGMENT_KEY
                  ? void 0 !== f
                    ...
                    : c(t, f, s, M, u, void 0 !== j ? j : null, p, h, x, m)
                  : _ && 0 === Object.keys(s[1]).length
                  ? c(t, f, s, M, u, void 0 !== j ? j : null, p, h, x, m)
                  : void 0 !== f &&
                    void 0 !== A &&
                    (0, a.matchSegment)(w, A) &&
                    void 0 !== M &&
                    void 0 !== f
                  ? e(t, M, f, s, u, j, p, h, _, x, m)
                  : c(t, f, s, M, u, void 0 !== j ? j : null, p, h, x, m))
            ) {
...
Event: ${(0, p.$X)(e)}`),
                  ...
                  if (
                    ((r = e),
                    (n = t.ignoreErrors),
                    n?.length && _(r).some((e) => (0, h.Xr)(e, n)))
                  )
                    return (
                      u.T &&
                        o.vF
...
Url: ${b(e)}`),
      ...
      function b(e) {
        try {
          ...
          return (
            u.T && o.vF.error(`Cannot extract url for event ${(0, p.$X)(e)}`),
            null
          );
        }
      }
          ...
          setupOnce() {
            ...
            try {
              Function.prototype.toString = function (...e) {
                let t = (0, R.sp)(this),
                  r = O.has((0, E.KU)()) && void 0 !== t ? t : this;
                return n.apply(r, e);
              };
            } catch {}
          },
      ...
      class ee {
        ...
        captureException(e, t, r) {
          let n = (0, p.eJ)();
          if ((0, p.GR)(e)) return u.T && o.vF.log(z), n;
          let a = { event_id: n, ...t };
          return (
            this._process(
        ...
        captureMessage(e, t, r, n) {
          let a = { event_id: (0, p.eJ)(), ...r },
            o = (0, H.NF)(e) ? e : String(e),
            i = (0, H.sO)(e)
        ...
        captureEvent(e, t, r) {
          let n = (0, p.eJ)();
          if (t?.originalException && (0, p.GR)(t.originalException))
            return u.T && o.vF.log(z), n;
          let a = { event_id: n, ...t },
        ...
        addIntegration(e) {
          ...
          d(this, e, this._integrations), t || f(this, [e]);
        }
        sendEvent(e, t = {}) {
          ...
          for (let e of t.attachments || []) r = (0, D.W3)(r, (0, D.bm)(e));
          let n = this.sendEnvelope(r);
          n && n.then((t) => this.emit("afterSendEvent", e, t), null);
        }
        sendSession(e) {
          let { release: t, environment: r = M.U } = this._options;
          if ("aggregates" in e) {
            let n = e.attrs || {};
            if (!n.release && !t) {
              u.T && o.vF.warn(K);
        ...
        sendEnvelope(e) {
          ...
          this._isEnabled() && this._transport)
            ...
            : (u.T && o.vF.error("Transport disabled"), (0, F.XW)({}));
        }
        _setupIntegrations() {
        ...
        _prepareEvent(e, t, r, n) {
          ...
          return (
            ...
            (0, W.mG)(a, e, t, r, this, n).then(
              (e) => (
                null === e ||
                  (this.emit("postprocessEvent", e, t),
                  (e.contexts = { trace: (0, E.vn)(r), ...e.contexts }),
                  (e.sdkProcessingMetadata = {
                    dynamicSamplingContext: (0, I.ao)(this, r),
                    ...e.sdkProcessingMetadata,
                  })),
                e
              )
        ...
        _captureEvent(e, t = {}, r = (0, E.o5)(), n = (0, E.rm)()) {
          return (
            u.T &&
              et(e) &&
              o.vF.log(`Captured error event \`${_(e)[0] || "<unknown>"}\``),
          ...
          return this._prepareEvent(e, t, r, n)
            .then((e) => {
              if (null === e)
                throw (
                  ...
                  Y("An event processor returned `null`, will not send event."))
                );
            ...
            .then((a) => {
              if (null === a) {
                ...
                throw Y(`${u} returned \`null\`, will not send event.`);
              }
...
Reason: ${e}`))
        ...
        _flushOutcomes() {
          ...
          let t = (function (e, t, r) {
            let n = [
              { type: "client_report" },
              { timestamp: (0, L.lu)(), discarded_events: e },
            ];
            return (0, D.h4)(t ? { dsn: t } : {}, [n]);
          })(e, this._options.tunnel && (0, U.SB)(this._dsn));
          this.sendEnvelope(t);
        }
      }
      function et(e) {
      ...
      function ei(e, t) {
        ...
        (r.length = 0), e.emit("flushLogs"), e.sendEnvelope(a);
      }
      function es(e) {
      ...
      function ef(e, t) {
        return { exception: { values: [ec(e, t)] } };
      }
      function ed(e, t) {
        var r, n;
      ...
      function e_(e, t, r, n, a) {
        let o;
        if ((0, H.T2)(t) && t.error) return ef(e, t.error);
        if ((0, H.BD)(t) || (0, H.W6)(t)) {
          if ("stack" in t) o = ef(e, t);
          else {
            let a = t.name || ((0, H.BD)(t) ? "DOMError" : "DOMException"),
              i = t.message ? `${a}: ${t.message}` : a;
            (o = eg(e, i, r, n)), (0, p.gO)(o, i);
          }
          return (
            "code" in t &&
          ...
          : ((0, H.Qd)(t) || (0, H.xH)(t)
              ? (o = (function (e, t, r, n) {
                  let a = (0, E.KU)(),
                    ...
                    s = { __serialized__: (0, eu.cd)(t, o) };
                  if (i) return { exception: { values: [ec(e, i)] }, extra: s };
                  let l = {
                    exception: {
                      values: [
                        {
              ...
              : ((o = eg(e, t, r, n)), (0, p.gO)(o, `${t}`, void 0)),
      ...
      class ey extends ee {
        constructor(e) {
          ...
          s(t, "browser", ["browser"], em.jf.SENTRY_SDK_SOURCE || (0, en.e)()),
            super(t);
          let r = this,
            { sendDefaultPii: n, _experiments: a } = r._options,
            o = a?.enableLogs;
          t.sendClientReports &&
            em.jf.document &&
            em.jf.document.addEventListener("visibilitychange", () => {
              "hidden" === em.jf.document.visibilityState &&
                (this._flushOutcomes(), o && ei(r));
            }),
            o &&
              (r.on("flush", () => {
                ei(r);
              ...
              r.on("afterCaptureLog", () => {
                r._logFlushIdleTimeout && clearTimeout(r._logFlushIdleTimeout),
                  (r._logFlushIdleTimeout = setTimeout(() => {
                    ei(r);
                  }, 5e3));
              })),
            n && (r.on("postprocessEvent", es), r.on("beforeSendSession", el));
        }
        eventFromException(e, t) {
          return (function (e, t, r, n) {
            let a = e_(e, t, r?.syntheticException || void 0, n);
            return (
              (0, p.M6)(a),
              (a.level = "error"),
        ...
        eventFromMessage(e, t = "info", r) {
          return (function (e, t, r = "info", n, a) {
            let o = eg(e, t, n?.syntheticException || void 0, a);
            return (
              (o.level = r),
              n?.event_id && (o.event_id = n.event_id),
              (0, F.XW)(o)
            );
          })(
      ...
      function eP() {
        "console" in a.O &&
          o.Ow.forEach(function (e) {
            e in a.O.console &&
              (0, R.GS)(a.O.console, e, function (t) {
                return (
                  (o.Z9[e] = t),
                  function (...t) {
                    (0, eO.aj)("console", { args: t, level: e });
                    let r = o.Z9[e];
      ...
      let eC = (e = {}) => {
                    ...
                    if ("assert" === e.level)
                      if (!1 !== e.args[0]) return;
                        ...
                        (t.message = `Assertion failed: ${
                          (0, h.gt)(e.args.slice(1), " ") || "console.assert"
                        }`),
                          (t.data.arguments = e.args.slice(1));
                    (0, eT.Z)(t, { input: e.args, level: e.level });
                  })
                ),
                t.dom &&
                  (0, eb.i)(
                    ...
                    function (e) {
                      ...
                      try {
                        ...
                        (t = (0, C.Hd)(a, { keyAttrs: i, maxStringLength: s })),
                          (r = (0, C.xE)(a));
                      } catch (e) {
                        t = "<unknown>";
                      }
                ...
                t.history &&
                  (0, eR._)(
                    ...
                    function (e) {
                      ...
                      let t = e.from,
                        r = e.to,
                        n = (0, ex.Dl)(em.jf.location.href),
                        a = t ? (0, ex.Dl)(t) : void 0,
                        o = (0, ex.Dl)(r);
                      a?.path || (a = n),
        ...
        eM = (e = {}) => {
          ...
          return {
            ...
            setupOnce() {
              t.setTimeout && (0, R.GS)(em.jf, "setTimeout", eN),
                t.setInterval && (0, R.GS)(em.jf, "setInterval", eN),
                t.requestAnimationFrame &&
                  (0, R.GS)(em.jf, "requestAnimationFrame", ek),
                t.XMLHttpRequest &&
                  "XMLHttpRequest" in em.jf &&
                  (0, R.GS)(XMLHttpRequest.prototype, "send", eI);
              let e = t.eventTarget;
              e && (Array.isArray(e) ? e : eA).forEach(eD);
            },
          };
        };
      function eN(e) {
          ...
          return (
            ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(
              (e) => {
                e in r &&
                  "function" == typeof r[e] &&
                  (0, R.GS)(r, e, function (t) {
                    let r = {
                        mechanism: {
                          data: { function: e, handler: (0, S.qQ)(t) },
                          handled: !1,
                          type: "instrument",
                        },
                      },
                      n = (0, R.sp)(t);
                    return (
                      n && (r.mechanism.data.handler = (0, S.qQ)(n)),
                      (0, em.LV)(t, r)
                    );
                  });
              }
      ...
      function eD(e) {
        ...
        r?.hasOwnProperty?.("addEventListener") &&
          ((0, R.GS)(r, "addEventListener", function (t) {
            return function (r, n, a) {
              try {
                var o;
                (o = n),
                  "function" == typeof o.handleEvent &&
                    (n.handleEvent = (0, em.LV)(n.handleEvent, {
                      mechanism: {
                        data: {
          ...
          (0, R.GS)(r, "removeEventListener", function (e) {
        ...
        return {
          ...
          setup(e) {
            ...
            t.onerror &&
              ((r = e),
              (0, eU.L)((e) => {
                let { stackParser: t, attachStacktrace: n } = eB();
                if ((0, E.KU)() !== r || (0, em.jN)()) return;
                let { msg: a, url: o, line: i, column: s, error: u } = e,
                  c = (function (e, t, r, n) {
              ...
              t.onunhandledrejection &&
                ...
                (0, eH.r)((e) => {
                  var t;
                  let { stackParser: r, attachStacktrace: a } = eB();
                  if ((0, E.KU)() !== n || (0, em.jN)()) return;
                  let o = (function (e) {
                      if ((0, H.sO)(e)) return e;
                      try {
      ...
      function e$(e) {
        ev.T && o.vF.log(`Global Handler attached: ${e}`);
      }
      function eB() {
        let e = (0, E.KU)();
        return (
      ...
      let eW = () => ({
        name: "HttpContext",
        preprocessEvent(e) {
          if (!em.jf.navigator && !em.jf.location && !em.jf.document) return;
          let t = e.request?.url || (0, C.$N)(),
            { referrer: r } = em.jf.document || {},
            { userAgent: n } = em.jf.navigator || {},
            a = {
              ...e.request?.headers,
              ...(r && { Referer: r }),
              ...(n && { "User-Agent": n }),
          ...
          preprocessEvent(e, n, a) {
            !(function (e, t, r, n, a, o) {
              if (
                !a.exception?.values ||
                !o ||
                !(0, H.tH)(o.originalException, Error)
              )
                return;
              let i =
              ...
              i &&
                (a.exception.values = (function e(t, r, n, a, o, i, s, l) {
                  ...
                  if ((0, H.tH)(a[o], Error)) {
                    ...
                    let i = t(r, a[o]),
                      c = u.length;
                    eq(i, o, c, l), (u = e(t, r, n, a[o], o, [i, ...u], i, c));
                  }
                  return (
            ...
            })(ec, a.getOptions().stackParser, r, t, e, n);
          },
        };
      };
      function eK(e, t, r, n) {
      ...
      let eG = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
        ...
        e0 = [
          ...
          (e) => {
            ...
            if (t) {
              ...
              return (
                ([r, e] = e3(r, e)),
                eK(e, r, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0)
              );
            }
          },
        ],
        ...
        e3 = (e, t) => {
          ...
          return r || n
            ? [
                -1 !== e.indexOf("@") ? e.split("@")[0] : S.yF,
                r ? `safari-extension:${t}` : `safari-web-extension:${t}`,
              ]
            : [e, t];
        };
      var e2 = r(7138);
      let e4 = Symbol.for("SentryBufferFullError");
      var e8 = r(396);
      function e6(e, t = (0, e2.qd)("fetch")) {

      }
      function e9(e) {
        return [y(), P(), eM(), eC(), eF(), ez(), T(), eW(), eL()];
      }
      var e5 = r(8276),
        e7 = r(842),
        te = r(8545),
        ...
        tn = r(7574),
        ta = r.n(tn);
      let to = ta().events ? ta() : ta().default,
        ti = em.jf,
        ts =
          /^(\S+:\\|\/?)([\s\S]*?)((?:\.{1,2}|[^/\\]+?|)(\.[^./\\]*|))(?:[/\\]*)$/;
      function tl(...e) {
      ...
      function t_(e) {
        ...
        let t = {
          environment:
            (function (e) {
              let t = e ? e7.env.NEXT_PUBLIC_VERCEL_ENV : e7.env.VERCEL_ENV;
          ...
          defaultIntegrations: (function (e) {
                ...
                (function (e = {}) {
                  ...
                  return {
                    ...
                    afterAllSetup(e) {
                      n &&
                        (function (e) {
                          if (em.jf.document.getElementById("__NEXT_DATA__"))
                            to.events.on("routeChangeStart", (t) => {
                              let r,
                                n,
                                a = (0, ex.f)(t),
                                o = (function (e) {
                                  let t = ti.__BUILD_MANIFEST?.sortedPages;
                                  if (t)
                                    return t.find((t) => {
                                      let r = (function (e) {
                                        let t = e.split("/"),
                        ...
                        r &&
                          (function (e) {
                            if (
                              em.jf.document.getElementById("__NEXT_DATA__")
                            ) {
                              let {
                                  route: t,
                                  params: r,
            ...
            let r = th._sentryRewriteFramesAssetPrefixPath || "",
              ...
              o =
                "true" === td.env._experimentalThirdPartyOriginStackFrames ||
                "true" === th._experimentalThirdPartyOriginStackFrames;
            return (
              t.push(
                tf({
                  assetPrefix: n,
          ...
          release: "68b132b4a2680948a58730729516f7bc9218a4e4",
          ...e,
        };
        !(function (e) {
          let t = "/monitoring";
        ...
        let r = (function (e) {
            ...
            return (
              s(t, "react"),
              (0, l.o)("react", { version: e5.version }),
              (function (e = {}) {
                var t;
                let r = (function (e = {}) {
                  return {
                    ...{
                      defaultIntegrations: e9(),
                      release:
                        "string" == typeof __SENTRY_RELEASE__
                          ? __SENTRY_RELEASE__
                          : em.jf.SENTRY_RELEASE?.id,
                      sendClientReports: !0,
                    },
                    ...(function (e) {
                      let t = {};
                ...
                if (
                  ...
                  (function () {
                    let e = void 0 !== em.jf.window && em.jf;
                    if (!e) return !1;
                ...
                let n = {
                  ...r,
                  stackParser: (0, S.vk)(r.stackParser || e1),
                ...
                !0 === n.debug &&
                  ...
                  (0, E.o5)().update(n.initialScope);
                let a = new ey(n);
                return (t = a), (0, E.o5)().setClient(t), a.init(), a;
              })(t)
            );
          })(t),
          n = (e) =>
    ...
    1623: (e, t, r) => {
      ...
      function M(e) {
        ...
        let { cache: x, tree: M, nextUrl: N, focusAndScrollRef: k } = d,
          I = (0, o.useMemo)(() => (0, g.findHeadInCache)(x, M[1]), [x, M]),
          L = (0, o.useMemo)(() => (0, b.getSelectedParams)(M), [M]),
          U = (0, o.useMemo)(
            () => ({
              parentTree: M,
              parentCacheNode: x,
          ...
          H = (0, o.useMemo)(
            () => ({ tree: M, focusAndScrollRef: k, nextUrl: N }),
            [M, k, N]
          );
        if (null !== I) {
          let [e, r] = I;
        ...
        let F = (0, a.jsxs)(_.RedirectBoundary, {
          children: [t, x.rsc, (0, a.jsx)(h.AppRouterAnnouncer, { tree: M })],
        });
        return (
    ...
    2064: (e, t, r) => {
      ...
      let n = r(8489)._(r(8276)).default.createContext(null);
    },
    2077: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    2232: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(8364);
      let n = r(3161),
        a = r(2901);
      (0, n.appBootstrap)(() => {
        let { hydrate: e } = r(9239);
        r(1623), r(2340), e(a);
      }),
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
    ...
    2259: (e, t, r) => {
      ...
      let n = r(8489)._(r(8276)).default.createContext({});
    },
    2264: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      let n = r(623).makeUntrackedExoticSearchParams;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, "__esModule", { value: !0 }),
    ...
    2856: (e, t, r) => {
              ...
              if (s.startsWith("/")) {
                ...
                return Promise.all([
                  ...
                  if ((0, p.isDynamicRoute)(f)) {
                    let e = (0, g.getRouteMatcher)((0, m.getRouteRegex)(f))(s);
      ...
      function z(e) {
        ...
        if (t === (0, O.addBasePath)((0, b.addLocale)(r.asPath, r.locale)))
          throw Object.defineProperty(
            Error(
      ...
      class G {
        ...
        async change(e, t, r, n, a) {
          ...
          let { shallow: J = !1, scroll: Y = !0 } = n,
            Q = { shallow: J };
          this._inFlightRoute &&
            this.clc &&
            (K ||
              G.events.emit("routeChangeError", D(), this._inFlightRoute, Q),
            this.clc(),
            (this.clc = null)),
            (r = (0, O.addBasePath)(
              (0, b.addLocale)(
          ...
          if (!$ && this.onlyAHashChange(Z) && !ee) {
            ...
            try {
              ...
              throw (
                ((0, l.default)(e) &&
                  e.cancelled &&
                  G.events.emit("routeChangeError", e, Z, Q),
                e)
              );
            }
          ...
          let es = !!(
              ...
              (!(0, p.isDynamicRoute)(eo) ||
                !(0, g.getRouteMatcher)((0, m.getRouteRegex)(eo))(ei))
            ),
            el =
              !n.shallow &&
              (await L({ asPath: r, locale: X.locale, router: this }));
          if (($ && el && (W = !1), W && "/_error" !== er))
            if (((n._shouldResolveHref = !0), r.startsWith("/"))) {
              let e = (0, _.default)(
                (0, O.addBasePath)((0, b.addLocale)(Z, X.locale), !0),
                I,
                U,
                en,
                (e) => F(e, I),
              ...
              el || (ea = e.asPath),
                e.matchedPage &&
                  e.resolvedHref &&
                  ((er = e.resolvedHref),
                  (et.pathname = (0, O.addBasePath)(er)),
          ...
          (ea = (0, E.removeLocale)((0, R.removeBasePath)(ea), X.locale)),
          ...
          try {
            ...
            if (
              ...
              if (
                ((X.isPreview = !!o.props.__N_PREVIEW), o.props.notFound === B)
              ) {
                let e;
                try {
            ...
            let u = n.shallow && X.route === (null != (T = o.route) ? T : eo),
            ...
            if (
              (G.events.emit("beforeHistoryChange", r, Q),
              ...
              if (o.error)
                throw (
                  ($ || G.events.emit("routeChangeError", o.error, Z, Q),
                  o.error)
                );
              $ || G.events.emit("routeChangeComplete", r, Q),
        ...
        async getRouteInfo(e) {
          ...
          try {
            ...
            if (s.shallow && e && this.route === m) return e;
            let t = K({ route: m, router: this });
            f && (e = void 0);
            ...
            if (
              ...
              h &&
                (S
                  ...
                  : (S = { json: self.__NEXT_DATA__.props })),
              t(),
              (null == S || null == (v = S.effect) ? void 0 : v.type) ===
                "redirect-internal" ||
            ...
            return (
              j.__N_SSP && P.dataHref && A && delete this.sdc[A],
              this.isPreview ||
                !j.__N_SSG ||
                h ||
                X(
        ...
        async prefetch(e, t, r) {
          ...
          let n = (0, h.parseRelativeUrl)(e),
            ...
            P = await L({ asPath: t, locale: d, router: this });
          if (t.startsWith("/")) {
            let r;
            ({ __rewrites: r } = await (0, i.getClientBuildManifest)());
            let a = (0, _.default)(
              (0, O.addBasePath)((0, b.addLocale)(t, this.locale), !0),
              c,
              r,
              n.query,
              (e) => F(e, c),
            ...
            P ||
              ...
              a.matchedPage &&
                a.resolvedHref &&
                ((n.pathname = s = a.resolvedHref),
                P || (e = (0, y.formatWithValidation)(n)));
          }
          (n.pathname = F(n.pathname, c)),
            (0, p.isDynamicRoute)(n.pathname) &&
              ...
              Object.assign(
                l,
                (0, g.getRouteMatcher)((0, m.getRouteRegex)(n.pathname))(
    ...
    2888: (e, t, r) => {
      ...
      let n = "" + r(9597).HTTP_ERROR_FALLBACK_ERROR_CODE + ";404";
      function a() {
    ...
    3185: (e, t, r) => {
      ...
      function a(e) {
        ...
        {
          let { createRenderSearchParamsFromClient: e } = r(2264),
            i = e(a),
            { createRenderParamsFromClient: s } = r(4909),
            l = s(o);
...
`),
    ...
    4890: (e, t, r) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        r(9597).HTTP_ERROR_FALLBACK_ERROR_CODE,
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
          (Object.defineProperty(t.default, "__esModule", { value: !0 }),
    ...
    4909: (e, t, r) => {
      ...
      let n = r(8220).makeUntrackedExoticParams;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, "__esModule", { value: !0 }),
        ...
        if (t && "function" == typeof t.createElement)
          try {
            ...
            (r.hidden = !0),
              ...
              r.contentWindow?.fetch && (e = l(r.contentWindow.fetch)),
    ...
    6123: (e, t, r) => {
      ...
      function a(e) {
        ...
        {
          let { createRenderParamsFromClient: e } = r(4909),
            i = e(o);
      ...
      class d {
        ...
        addBreadcrumb(e, t) {
          ...
          let n = {
            timestamp: (0, u.lu)(),
            ...e,
            message: e.message ? (0, l.xv)(e.message, 2048) : e.message,
          };
          return (
    ...
    6595: (e, t, r) => {
      ...
      let n = r(4380),
        ...
        l = r(7991),
        u = r(6378),
        { createFromReadableStream: c } = r(9744);
      function f(e) {
...
Error:`,
    ...
    6979: (e, t, r) => {
      ...
      function _(e) {
        ...
        let r = (0, u.zU)(e),
          ...
          h = d?.get("sentry.sample_rate") ?? s[o.sy];
        function _(e) {
          return (
        ...
        return (
          ...
          (0, l.f)() &&
            ((v.sampled = String((0, u.pK)(r))),
            (v.sample_rand =
              d?.get("sentry.sample_rand") ??
              (0, c.L)(r)
    ...
    7084: (e, t, r) => {
      ...
      function O(e, t, r, v, R, O) {
        var P, S, T, j, w, x;
        let { normalizeDepth: C = 3, normalizeMaxBreadth: A = 1e3 } = e,
          M = {
            ...t,
        ...
        r.mechanism && (0, h.M6)(M, r.mechanism);
        ...
        return (
          ...
          })([...I, ...D.eventProcessors], M, r).then((e) =>
            (e &&
              (function (e) {
                let t = {};
                if (
    ...
    7356: (e, t, r) => {
      ...
      let n = r(3400),
        a = r(8276),
        o = r(8333).BrowserResolvedMetadata;
      function i(e) {
        let { promise: t } = e,
    ...
    8054: (e, t, r) => {
      ...
      let a = -1,
        o = () =>
          "hidden" !== n.j.document.visibilityState || n.j.document.prerendering
            ? 1 / 0
            : 0,
        i = (e) => {
    ...
    8192: (e, t, r) => {
        ...
        p = (e, t, r, n) => {
          ...
          return (i) => {
            t.value >= 0 &&
              ...
              ((a = t.value), (t.delta = o), (t.rating = d(t.value, r)), e(t));
          };
        };
      var h = r(8266);
      let _ = () =>
      ...
      let y = (e, t) => {
          ...
          return (
            r &&
              (h.j.document?.prerendering || (0, g.b)() > 0
                ? (n = "prerender")
                : h.j.document?.wasDiscarded
                ? (n = "restore")
      ...
      let O = (e) => {
                ...
                e.forEach((e) => {
                  "first-contentful-paint" === e.name &&
                    ...
                    e.startTime < n.firstHiddenTime &&
                      ((a.value = Math.max(e.startTime - (0, g.b)(), 0)),
                      a.entries.push(e),
                      r(!0)));
                });
              });
        ...
        N = (e) => {
          e.forEach((e) => {
            e.interactionId &&
              ...
              (C = (M = Math.max(M, e.interactionId)) ? (M - A) / 7 + 1 : 0));
          });
        },
        ...
        $ = (e) => {
          ...
          if (r || D.length < 10 || (t && e.duration > t.latency)) {
            ...
            D.sort((e, t) => t.latency - e.latency),
              D.length > 10 && D.splice(10).forEach((e) => L.delete(e.id));
          }
        },
        B = (e) => {
          ...
          return (
            (e = E(e)),
            h.j.document?.visibilityState === "hidden"
              ? e()
              : ((r = t(e)), (0, b.Q)(e)),
            r
          );
        ...
        K = (e, t = {}) => {
          O(() => {
            ...
            if (i) {
              ...
              let n = E(() => {
                z[a.id] ||
                  (o(i.takeRecords()), i.disconnect(), (z[a.id] = !0), r(!0));
              });
        ...
        V = (e) => {
          h.j.document?.prerendering
            ? O(() => V(e))
            : h.j.document?.readyState !== "complete"
...
Error:`,
    ...
    8364: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(4563);
      let n = r(5588);
      {
        let e = r.u;
        r.u = function () {
    ...
    8545: (e, t, r) => {
      ...
      class P {
        constructor(e = {}) {
          (this._traceId = e.traceId || (0, O.e)()),
            (this._spanId = e.spanId || (0, O.Z)());
        }
        spanContext() {
          return {
            spanId: this._spanId,
      ...
      class j {
        constructor(e = {}) {
          (this._traceId = e.traceId || (0, O.e)()),
            (this._spanId = e.spanId || (0, O.Z)()),
            (this._startTime = e.startTimestamp || (0, o.zf)()),
            (this._links = e.links),
            (this._attributes = {}),
            this.setAttributes({
              [s.JD]: "manual",
        ...
        spanContext() {
          ...
          return { spanId: e, traceId: t, traceFlags: r ? i.aO : i.CC };
        }
        setAttribute(e, t) {
          return (
            void 0 === t
        ...
        getSpanJSON() {
          return {
            ...
            status: (0, i.yW)(this._status),
            timestamp: this._endTime,
            trace_id: this._traceId,
            origin: this._attributes[s.JD],
            profile_id: this._attributes[s.E1],
            exclusive_time: this._attributes[s.jG],
            measurements: f(this._events),
            is_segment:
              (this._isStandaloneSpan && (0, i.zU)(this) === this) || void 0,
            segment_id: this._isStandaloneSpan
              ? (0, i.zU)(this).spanContext().spanId
              : void 0,
            links: (0, i.uU)(this._links),
          };
        }
        isRecording() {
        ...
        addEvent(e, t, r) {
          u.T && c.vF.log("[Tracing] Adding an event to span:", e);
          let n = w(t) ? t : r || (0, o.zf)(),
            a = w(t) ? {} : t || {},
            s = { name: e, time: (0, i.cI)(n), attributes: a };
        ...
        _onSpanEnded() {
          ...
          if (
            ...
            !(this._isStandaloneSpan || this === (0, i.zU)(this)))
          )
            return;
          ...
          t && ((0, T.L)(this).scope || (0, h.o5)()).captureEvent(t);
        }
        _convertSpanToTransaction() {
          if (!x((0, i.et)(this))) return;
          this._name ||
            (u.T &&
              c.vF.warn(
          ...
          let r = (0, i.xO)(this)
              .filter((e) => {
                var t;
                return (
                  e !== this && !((t = e) instanceof j && t.isStandaloneSpan())
                );
              })
              .map((e) => (0, i.et)(e))
              .filter(x),
            n = this._attributes[s.i_];
          delete this._attributes[s.Le],
            r.forEach((e) => {
              delete e.data[s.Le];
            });
          let a = {
              contexts: { trace: (0, i.Ck)(this) },
              spans:
                r.length > 1e3
                  ? r
              ...
              sdkProcessingMetadata: {
                ...
                dynamicSamplingContext: (0, R.k1)(this),
              },
      ...
      function A(e) {
        ...
        let r = (function (e) {
            ...
            if (e.startTime) {
              let r = { ...t };
              return (
                (r.startTimestamp = (0, i.cI)(e.startTime)),
                delete r.startTime,
                r
              );
            }
                ...
                if (e && !r)
                  (a = (function (e, t, r) {
                    let { spanId: n, traceId: a } = e.spanContext(),
                      o =
                        !t.getScopeData().sdkProcessingMetadata[C] &&
                        (0, i.pK)(e),
                      s = o
                        ? new j({
                            ...r,
                  ...
                  let r = (0, R.k1)(e),
                    ...
                    l = (0, i.pK)(e);
                  (a = k({ traceId: o, parentSpanId: s, ...t }, n, l)),
                    (0, R.LZ)(a, r);
                } else {
                  let {
                    traceId: e,
                  ...
                  (a = k({ traceId: e, parentSpanId: i, ...t }, n, s)),
                    r && (0, R.LZ)(a, r);
                }
                return (
                  !(function (e) {
                    ...
                    let {
                      ...
                      s = (0, i.zU)(e),
                      l = s === e,
                      f = `[Tracing] Starting ${o ? "sampled" : "unsampled"} ${
                        l ? "root " : ""
                      }span`,
                      d = [`op: ${r}`, `name: ${t}`, `ID: ${a}`];
                    if ((n && d.push(`parent ID: ${n}`), !l)) {
                      let { op: e, description: t } = (0, i.et)(s);
  ...
  ${d.join("\n  ")}`);
      ...
      function k(e, t, r) {
        let n = (0, h.KU)(),
          ...
          [f, d, p] = t.getScopeData().sdkProcessingMetadata[C]
            ? [!1]
            : (function (e, t, r) {
                let n, a;
                if (!(0, v.f)(e)) return [!1];
                ...
                a,
                {
                  ...
                  parentSampled: r,
                  attributes: i,
                  parentSampleRate: (0, b.i)(l.dsc?.sample_rate),
                },
                l.sampleRand
              ),
          _ = new j({
      ...
      function D(e, t, r, { ...n }) {
        let a = (0, i.et)(e).start_timestamp;
        return (
          a &&
            a > t &&
      ...
      function L(e) {
        ...
        let { name: n, transaction: a, attributes: o, startTime: i } = e,
          ...
          d = (0, h.o5)(),
          _ = d.getUser(),
          g = void 0 !== _ ? _.email || _.id || _.ip_address : void 0;
        try {
        ...
        return A({
          ...
          attributes: {
            ...
            replay_id: f || void 0,
            transaction: a,
            "user_agent.original": p.j.navigator?.userAgent,
      ...
      function U() {
        return p.j.addEventListener && p.j.performance;
      }
      function H(e) {
        return e / 1e3;
      }
      ...
      var Q = r(7851),
        Z = r(6938);
      let ee = { idleTimeout: 1e3, finalTimeout: 3e4, childSpanTimeout: 15e3 };
      function et(e, t = {}) {
        let r,
          n = new Map(),
          a = !1,
          ...
          d = [],
          {
            idleTimeout: p = ee.idleTimeout,
            finalTimeout: _ = ee.finalTimeout,
            childSpanTimeout: g = ee.childSpanTimeout,
            beforeSpanEnd: m,
          } = t,
          y = (0, h.KU)();
        if (!y || !(0, v.f)()) {
          let e = new P(),
            t = { sample_rate: "0", sampled: "false", ...(0, R.k1)(e) };
          return (0, R.LZ)(e, t), e;
        }
        let b = (0, h.o5)(),
          O = (0, i.Bk)(),
          S = (function (e) {
            ...
            return (
              (0, E.r)((0, h.o5)(), t),
              u.T && c.vF.log("[Tracing] Started span is an idle span"),
              t
            );
          })(e);
        function T() {
        ...
        function j(e) {
          T(),
            (r = setTimeout(() => {
              !a && 0 === n.size && f && ((l = "idleTimeout"), S.end(e));
            }, p));
        }
        function w(e) {
          r = setTimeout(() => {
            !a && f && ((l = "heartbeatFailed"), S.end(e));
          }, g);
        }
        function x(e) {
          (a = !0), n.clear(), d.forEach((e) => e()), (0, E.r)(b, O);
          let t = (0, i.et)(S),
            { start_timestamp: r } = t;
          if (!r) return;
          t.data[s.fs] || S.setAttribute(s.fs, l),
            c.vF.log(`[Tracing] Idle span "${t.op}" finished`);
          let o = (0, i.xO)(S).filter((e) => e !== S),
            f = 0;
          o.forEach((t) => {
            t.isRecording() &&
              (t.setStatus({ code: Z.TJ, message: "cancelled" }),
              t.end(e),
              u.T &&
                c.vF.log(
            ...
            let { timestamp: r = 0, start_timestamp: n = 0 } = (0, i.et)(t),
              a = n <= e,
              o = r - n <= (_ + p) / 1e3;
            if (u.T) {
            ...
            f > 0 && S.setAttribute("sentry.idle_span_discarded_spans", f);
        }
        return (
          (S.end = new Proxy(S.end, {
            apply(e, t, r) {
              if ((m && m(S), t instanceof P)) return;
              let [n, ...a] = r,
                s = n || (0, o.zf)(),
                l = (0, i.cI)(s),
                u = (0, i.xO)(S).filter((e) => e !== S);
              if (!u.length) return x(l), Reflect.apply(e, t, [l, ...a]);
              let c = u.map((e) => (0, i.et)(e).timestamp).filter((e) => !!e),
                f = c.length ? Math.max(...c) : void 0,
                d = (0, i.et)(S).start_timestamp,
                p = Math.min(
                  d ? d + _ / 1e3 : 1 / 0,
                  Math.max(d || -1 / 0, Math.min(l, f || 1 / 0))
                );
              return x(p), Reflect.apply(e, t, [p, ...a]);
            },
          })),
          d.push(
            y.on("spanStart", (e) => {
          ...
          t.disableAutoFinish || j(),
          setTimeout(() => {
            a ||
              (S.setStatus({ code: Z.TJ, message: "deadline_exceeded" }),
              (l = "finalTimeout"),
              S.end());
          }, _),
          S
      ...
      function eo() {
        ...
        if (t) {
          ...
          u.T && c.vF.log(`[Tracing] Root span: ${e} -> Global error occurred`),
            t.setStatus({ code: Z.TJ, message: e });
        }
      }
        ...
        let a = (0, h.o5)(),
          ...
          s = o
            ...
            : (function (e) {
                ...
                return (0, es.TC)(t, n, r);
              })(a),
          l = o ? (0, R.k1)(o) : (0, R.ao)(t, a),
          u = (0, eh.De)(l);
        return es.MI.test(s)
          ? { "sentry-trace": s, baggage: u }
          : (c.vF.warn("Invalid sentry-trace data. Cannot generate trace data"),
            {});
      }
      function em(e) {
        return e
          .split(",")
          .filter((e) => !e.split("=")[0].startsWith(eh.sv))
          .join(",");
      }
      var ey = r(2750);
      let ev = new WeakMap(),
      ...
      function eR(e) {
        let { url: t } = (0, i.et)(e).data;
        if (!t || "string" != typeof t) return;
        let r = (0, g.wv)("resource", ({ entries: n }) => {
          n.forEach((n) => {
            "resource" === n.entryType &&
              ...
              n.name.endsWith(t) &&
              ((function (e) {
                let { name: t, version: r } = F(e.nextHopProtocol),
                  n = [];
                return (n.push(
                ...
                (0, o.k3)())
                  ? [
                      ...n,
                      ["http.request.redirect_start", eO(e.redirectStart)],
                      ["http.request.fetch_start", eO(e.fetchStart)],
                      [
                        "http.request.domain_lookup_start",
                        eO(e.domainLookupStart),
                      ],
                      ["http.request.domain_lookup_end", eO(e.domainLookupEnd)],
                      ["http.request.connect_start", eO(e.connectStart)],
                      [
                        "http.request.secure_connection_start",
                        eO(e.secureConnectionStart),
                      ],
                      ["http.request.connection_end", eO(e.connectEnd)],
                      ["http.request.request_start", eO(e.requestStart)],
                      ["http.request.response_start", eO(e.responseStart)],
                      ["http.request.response_end", eO(e.responseEnd)],
                    ]
                  : n;
      ...
      function eO(e = 0) {
        return (((0, o.k3)() || performance.timeOrigin) + e) / 1e3;
      }
      function eP(e) {
        try {
          return new URL(e, ec.jf.location.origin).href;
        } catch {
          return;
        }
      }
      let eS = "sentry_previous_trace";
      function eT(e, t) {
        let r = (0, i.et)(t);
        if (!e)
          return {
        ...
        let n = e.spanContext;
        return n.traceId === r.trace_id
          ? e
          : (Date.now() / 1e3 - e.startTimestamp <= 3600 &&
              (eu.T &&
                c.vF.info(
                  `Adding previous_trace ${n} link to span ${{
                    op: r.op,
                    ...t.spanContext(),
                  }}`
                ),
              ...
              t.setAttribute(
                ...
                `${n.traceId}-${n.spanId}-${+(1 === n.traceFlags)}`
              )),
            {
              spanContext: t.spanContext(),
              startTimestamp: (0, i.et)(t).start_timestamp,
            });
      }
      let ej = {
          ...ee,
        ...
        ew = (e = {}) => {
          let t = ec.jf.document;
          ea || ((ea = !0), (0, er.L)(eo), (0, en.r)(eo));
          let {
              enableInp: r,
              enableLongTask: f,
              ...
              instrumentNavigation: eh,
              linkPreviousTrace: e_,
              onRequestSpanStart: eO,
            } = { ...ej, ...e },
            ew = (function ({ recordClsStandaloneSpans: e }) {
              let t = U();
              if (t && (0, o.k3)()) {
                t.mark && p.j.performance.mark("sentry-tracing-init");
                let r = (0, g.T5)(({ metric: e }) => {
                    let t = e.entries[e.entries.length - 1];
                    if (!t) return;
                    let r = H((0, o.k3)()),
                      n = H(t.startTime);
                    (z.fid = { value: e.value, unit: "millisecond" }),
                      (z["mark.fid"] = { value: r + n, unit: "second" });
                  }),
                  u = (0, g.Pt)(({ metric: e }) => {
                    let t = e.entries[e.entries.length - 1];
                    t &&
                  ...
                  d = e
                    ? (function () {
                        ...
                        function a() {
                          n ||
                            ...
                            t &&
                              (function (e, t, r) {
                                _.T && c.vF.log(`Sending CLS span (${e})`);
                                let n = H(
                                    ((0, o.k3)() || 0) + (t?.startTime || 0)
                                  ),
                                  a = (0, h.o5)().getScopeData()
                                    .transactionName,
                                  i = L({
                                    name: t
                                      ? (0, l.Hd)(t.sources[0]?.node)
                                      : "Layout shift",
                                    transaction: a,
                                    attributes: {
                                ...
                                i &&
                                  (i.addEvent("cls", { [s.Sn]: "", [s.xc]: e }),
                                  i.end(n));
                              })(r, e, t),
                            u());
                        }
                        let u = (0, g.a9)(({ metric: t }) => {
                    ...
                    : (0, g.a9)(({ metric: e }) => {
                        let t = e.entries[e.entries.length - 1];
                        t && ((z.cls = { value: e.value, unit: "" }), (a = t));
                      }, !0);
                return () => {
                  r(), u(), f(), d?.();
                };
          ...
          r &&
            (function () {
              if (U() && (0, o.k3)()) {
                let e = (0, g.hT)(({ metric: e }) => {
                  if (void 0 == e.value) return;
                  let t = e.entries.find(
                    (t) => t.duration === e.value && Y[t.name]
                  );
                  if (!t) return;
                  let { interactionId: r } = t,
                    n = Y[t.name],
                    a = H((0, o.k3)() + t.startTime),
                    u = H(e.value),
                    c = (0, i.Bk)(),
                    f = c ? (0, i.zU)(c) : void 0,
                    d = (null != r ? J.get(r) : void 0) || f,
                    p = d
                      ? (0, i.et)(d).description
                      : (0, h.o5)().getScopeData().transactionName,
                    _ = L({
                      name: (0, l.Hd)(t.target),
                      transaction: p,
                      attributes: {
                        [s.JD]: "auto.http.browser.inp",
                        [s.uT]: `ui.interaction.${n}`,
                        [s.jG]: t.duration,
                      },
                      startTime: a,
                    });
            ...
            PerformanceObserver.supportedEntryTypes.includes(
              ...
              ? new PerformanceObserver((e) => {
                  ...
                  if (t)
                    for (let r of e.getEntries()) {
                      ...
                      let e = H((0, o.k3)() + r.startTime),
                        { start_timestamp: n, op: a } = (0, i.et)(t);
                      if ("navigation" === a && n && e < n) continue;
                      let l = H(r.duration),
                        u = { [s.JD]: "auto.ui.browser.metrics" },
                        {
                          invoker: c,
                          invokerType: f,
                          sourceURL: d,
                      ...
                      (u["browser.script.invoker"] = c),
                        (u["browser.script.invoker_type"] = f),
                        d && (u["code.filepath"] = d),
                        p && (u["code.function"] = p),
                        -1 !== h &&
                          (u["browser.script.source_char_position"] = h),
                        D(t, e, e + l, {
              ...
              : f &&
                (0, g.wv)("longtask", ({ entries: e }) => {
                  let t = (0, i.Bk)();
                  if (!t) return;
                  let { op: r, start_timestamp: n } = (0, i.et)(t);
                  for (let a of e) {
                    let e = H((0, o.k3)() + a.startTime),
                      i = H(a.duration);
                    ("navigation" === r && n && e < n) ||
                      D(t, e, e + i, {
                        name: "Main UI thread blocked",
          ...
          let eN = { name: void 0, source: void 0 };
          function ek(e, r) {
            var f, _;
            let g = "pageload" === r.op,
              m = E ? E(r) : r,
              y = m.attributes || {};
            r.name !== m.name && ((y[s.i_] = "custom"), (m.attributes = y)),
              (eN.name = m.name),
              (eN.source = y[s.i_]);
            let v = et(m, {
              idleTimeout: S,
              ...
              beforeSpanEnd: (t) => {
                ...
                ew(),
                  (function (e, t) {
                    let r = U(),
                      f = (0, o.k3)();
                    if (!r?.getEntries || !f) return;
                    let h = H(f),
                      _ = r.getEntries(),
                      { op: g, start_timestamp: m } = (0, i.et)(e);
                    if (
                      (_.slice(q).forEach((t) => {
                        let r = H(t.startTime),
                          n = H(Math.max(0, t.duration));
                        if ("navigation" !== g || !m || !(h + r < m))
                          switch (t.entryType) {
                            case "navigation":
                              var a, o, i;
                              (a = e),
                                ...
                                K(a, o, "secureConnection", i, "TLS/SSL"),
                                K(a, o, "fetch", i, "cache"),
                                K(a, o, "domainLookup", i, "DNS"),
                                (function (e, t, r) {
                                  let n = r + H(t.requestStart),
                                    a = r + H(t.responseEnd),
                                    o = r + H(t.responseStart);
                                  t.responseEnd &&
                                    (D(e, n, a, {
                                      op: "browser.request",
                                      name: t.name,
                            ...
                            case "measure": {
                              !(function (e, t, r, n, a) {
                                let o = (0, W.z)(!1),
                                  i =
                                    a + Math.max(r, H(o ? o.requestStart : 0)),
                                  l = a + r,
                                  u = l + n,
                                  c = {
                                ...
                                i !== l &&
                                  ...
                                  (c["sentry.browser.measure_start_time"] = i)),
                                  i <= u &&
                                    D(e, i, u, {
                                      name: t.name,
                                      op: t.entryType,
                            ...
                            case "resource":
                              !(function (e, t, r, n, a, o) {
                                ...
                                null != u &&
                                  (l["http.response_delivery_type"] = u);
                                let c = t.renderBlockingStatus;
                                c && (l["resource.render_blocking_status"] = c),
                                  i.protocol &&
                                    (l["url.scheme"] = i.protocol
                                      .split(":")
                                      .pop()),
                                  i.host && (l["server.address"] = i.host),
                                  (l["url.same_origin"] = r.includes(
                                    p.j.location.origin
                                  ));
                                let { name: f, version: h } = F(
                                  t.nextHopProtocol
                                );
                                (l["network.protocol.name"] = f),
                                  (l["network.protocol.version"] = h);
                                let _ = o + n;
                                D(e, _, _ + a, {
                                  name: r.replace(p.j.location.origin, ""),
                                  op: t.initiatorType
                      ...
                      r &&
                        z.fid &&
                        (D(e, r.value, r.value + H(z.fid.value), {
                          name: "first input delay",
                          op: "ui.action",
                          attributes: { [s.JD]: "auto.ui.browser.metrics" },
                        }),
                        delete z["mark.fid"]),
                        ("fcp" in z && t.recordClsOnPageloadSpan) ||
                          delete z.cls,
                        Object.entries(z).forEach(([e, t]) => {
                          !(function (e, t, r, n = (0, i.Bk)()) {
                            let a = n && (0, i.zU)(n);
                            a &&
                              (u.T &&
                                c.vF.log(
                        ...
                        e.setAttribute("performance.timeOrigin", h),
                        e.setAttribute(
                        ...
                        n &&
                          (n.element &&
                            y.setAttribute("lcp.element", (0, l.Hd)(n.element)),
                          n.id && y.setAttribute("lcp.id", n.id),
                          n.url &&
                            y.setAttribute(
                              "lcp.url",
                          ...
                          null != n.loadTime &&
                            y.setAttribute("lcp.loadTime", n.loadTime),
                          null != n.renderTime &&
                            y.setAttribute("lcp.renderTime", n.renderTime),
                          y.setAttribute("lcp.size", n.size)),
                        a?.sources &&
                    ...
                    (n = void 0), (a = void 0), (z = {});
                  })(t, { recordClsOnPageloadSpan: !b }),
                  (r = e),
                  (f = void 0),
                  (0, el.my)(r, eM, f);
                let _ = (0, h.o5)(),
                  g = _.getPropagationContext();
            ...
            afterAllSetup(e) {
              ...
              if (
                (e.on("startNavigationSpan", (t) => {
                  (0, h.KU)() === e &&
                    (m(),
                    (0, h.rm)().setPropagationContext({
                      traceId: (0, O.e)(),
                      sampleRand: Math.random(),
                    }),
                    (0, h.o5)().setPropagationContext({
                      traceId: (0, O.e)(),
                      sampleRand: Math.random(),
                    }),
                    ek(e, { op: "navigation", ...t }));
                }),
                e.on("startPageLoadSpan", (t, r = {}) => {
                  if ((0, h.KU)() !== e) return;
                  m();
                  let n = r.sentryTrace || eA("sentry-trace"),
                    a = r.baggage || eA("baggage"),
                    o = (0, es.kM)(n, a);
                  (0, h.o5)().setPropagationContext(o),
                    ek(e, { op: "pageload", ...t });
                }),
                "off" !== e_)
              ) {
                ...
                e.on("spanStart", (e) => {
                  if ((0, i.zU)(e) === e)
                    if ("session-storage" === e_) {
                      var r = eT(
                        (function () {
                          try {
                            let e = ec.jf.sessionStorage?.getItem(eS);
                            return JSON.parse(e);
                          } catch (e) {
                            return;
                          }
                      ...
                      try {
                        ec.jf.sessionStorage.setItem(eS, JSON.stringify(r));
                      } catch (e) {
                        eu.T &&
                          c.vF.warn(
              ...
              w &&
                (ec.jf.document
                  ? ec.jf.document.addEventListener("visibilitychange", () => {
                      ...
                      if (!e) return;
                      let t = (0, i.zU)(e);
                      if (ec.jf.document.hidden && t) {
                        let e = "cancelled",
                          { op: r, status: n } = (0, i.et)(t);
                        eu.T &&
                          c.vF.log(
                            `[Tracing] Transaction: ${e} -> since tab moved to the background, op: ${r}`
                          ),
                          n || t.setStatus({ code: Z.TJ, message: e }),
                          t.setAttribute(
                  ...
                  ec.jf.document &&
                    addEventListener(
                      ...
                      () => {
                        ...
                        if (
                          r &&
                          ["navigation", "pageload"].includes((0, i.et)(r).op)
                        ) {
                          eu.T &&
                            c.vF.warn(
                ...
                r &&
                  (function () {
                    ...
                    (0, g.wv)("event", e), (0, g.wv)("first-input", e);
                  })(),
                (function (e, t) {
                  let {
                      traceFetch: r,
                    ...
                    _ = (e) =>
                      (function (e, t) {
                        ...
                        if (r) {
                          ...
                          let o = n.origin === a;
                          return t
                            ? (0, ey.Xr)(n.toString(), t) ||
                                (o && (0, ey.Xr)(n.pathname, t))
                            : o;
                        }
                        {
                          let r = !!e.match(/^\/(?!\/)/);
                          return t ? (0, ey.Xr)(e, t) : r;
                        }
                      })(e, c),
                    g = {};
                  r &&
                        ...
                        "transaction" === e.type &&
                          ...
                          e.spans.forEach((e) => {
                            if ("http.client" === e.op) {
                              ...
                              t &&
                                ((e.timestamp = t / 1e3), eb.delete(e.span_id));
                            }
                          }),
                        e
                      )
                    ...
                    (0, ed.ur)((e) => {
                      let t = (function (e, t, r, n, a = "auto.http.browser") {
                        ...
                        let { method: o, url: l } = e.fetchData,
                          u = (0, v.f)() && t(l);
                        if (e.endTimestamp && u) {
                        ...
                        if (p) {
                          ...
                          p.emit("beforeOutgoingRequestSpan", f, t);
                        }
                        return f;
                      })(e, p, _, g);
                      if (
                        (e.response &&
                          e.fetchData.__span &&
                          ev.set(e.response, e.fetchData.__span),
                        t)
                      ) {
                        let r = eP(e.fetchData.url),
                          n = r ? (0, d.Dl)(r).host : void 0;
                        ...
                        let t = (function (e, t, r, n) {
                          ...
                          if (e.endTimestamp && c) {
                            ...
                            t &&
                              ...
                              ((0, Z.N8)(t, o.status_code),
                              t.end(),
                              delete n[e]);
                            return;
                          }
                          let f = eP(l),
                            p = f ? (0, d.Dl)(f) : (0, d.Dl)(l),
                            _ = (0, d.f)(l),
                            g = !!(0, i.Bk)(),
                            m =
                              c && g
                          ...
                          (a.__sentry_xhr_span_id__ = m.spanContext().spanId),
                            (n[a.__sentry_xhr_span_id__] = m),
                            r(l) &&
                              (function (e, t) {
                                let { "sentry-trace": r, baggage: n } = eg({
                                  span: t,
                                });
                                r &&
                                  (function (e, t, r) {
                          ...
                          let y = (0, h.KU)();
                          return (
                            y && y.emit("beforeOutgoingRequestSpan", m, e), m
                          );
                        })(e, p, _, g);
                        if (t) {
                          let r;
      ...
      function ex(e, t, r) {
        return (
          ...
          (0, h.o5)().setTransactionName(t.name),
          e[eM]
        );
      }
      function eC(e, t) {
